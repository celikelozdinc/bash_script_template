...
readonly log_file="${current_dir}/report.log"
...
disk_usage_report "BEFORE" "${log_file}" # MUST be the first command, flushes current log file
...
docker_resource_usage_report "${log_file}"
...
disk_usage_report "AFTER" "${log_file}"
